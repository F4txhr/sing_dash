export const THEMES = {
  ...
  neon: {
    ...
    name: "Neon",
    card:
      "rounded-2xl bg-transparent backdrop-blur-xl border border-sky-500/40 shadow-[0_0_30px_-12px_rgba(56,189,248,0.9)]",
    sidebar:
      "bg-slate-950/70 backdrop-blur-xl border border-sky-500/40 shadow-[0_0_35px_-16px_rgba(56,189,248,0.9)]",
    bottomNav:
      "border border-sky-500/40 bg-slate-950/75 backdrop-blur-xl shadow-[0_0_30px_-18px_rgba(56,189,248,0.8)]",
    background:
  ...
  aurora: {
    ...
    name: "Aurora Glass",
    card:
      "rounded-2xl bg-transparent backdrop-blur-xl border border-emerald-300/50 shadow-[0_0_40px_-18px_rgba(45,212,191,0.8)]",
    sidebar:
  ...
  matrix: {
    ...
    name: "Matrix",
    card:
      "rounded-2xl bg-transparent backdrop-blur-xl border border-emerald-500/50 shadow-[0_0_36px_-18px_rgba(34,197,94,0.9)]",
    sidebar:
      "bg-black border border-emerald-500/50 shadow-[0_0_36px_-18px_rgba(34,197,94,0.9)]",
    bottomNav:
